...
# Script based on work by https://github.com/nicklhw
...
echo "*** Please Run: export VAULT_ADDR=http://${VAULT_ADDR}"
echo "*** Please Run: export VAULT_TOKEN=${VAULT_TOKEN}"
echo "*** Vault Unseal Key(s) [Base64]: ${unseal_key}"
echo "*** Vault Unseal Key(s) [Hex]: ${unseal_hex}"
